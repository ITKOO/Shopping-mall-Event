            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
 						<div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1" style = "margin-bottom: 20px;">이벤트 시간 설정하기</h2>
                                    <div style = "background-color: #fbb710;" class = "openBtn">
						                <a href="openProc.jsp?item_num=<%=item_num %>" style = "color:#fff;padding:10px;font-weight: bold;">&nbsp;이벤트 오픈하기&nbsp;</a>
						            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                               <form name="itemForm" method="post" action="eventAdminProc.jsp?item_num=<%=item_num %>" class="form-horizontal">
            				<div class="card">
                        ...
                        <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        ...
                                        <input type="text" id="opentime" name="opentime" placeholder = "<%=timeExplain %>" class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="card-footer">
                            ...
                            <button type="reset" class="btn btn-danger btn-sm" data-dismiss="modal" onclick = "location.href='event_admin.jsp'">
