        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">아이템 올리기</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form name="itemForm"  method="post" enctype="multipart/form-data" method="post" action="adminProc.jsp" class="form-horizontal">
            <div class="card">
                        ...
                        <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="item_explain" id="item_explain" rows="9" class="form-control"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="item_price" class=" form-control-label">아이템 가격</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">  
                                                <h2>
                                                <script id="_wauo7m">var _wau = _wau || []; _wau.push(["dynamic", "jgun3roj6o", "o7m", "e5497dffffff", "big"]);</script><script async src="//waust.at/d.js"></script>
                                                
                                                </h2>
                                                <span></script>총 방문자수</span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-collection-image"></i>Item List</h3>
		...
		Connection conn = DriverManager.getConnection(url, id, pw); //실제연동시도
	  	...
	  	while(rs.next()){  		
             ...
             */
             ...
             out.println("<a style = 'display:block;' href = 'view_admin_detail.jsp?item_num="+ item_num+"'><div class='au-message__item unread'><div class='au-message__item-inner'><div class='au-message__item-text'><div class='avatar-wrap "+ status +"'><div class='avatar'><img src='img/item/"+ 
