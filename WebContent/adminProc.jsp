...
<%
	...
	try{
		Connection conn = DriverManager.getConnection(url, id, pw); //실제연동시도
	  	...
	  	String sql = "insert into item_list(item_name,item_explain,item_price,item_status,imgAddress1,imgAddress2,imgAddress3,imgAddress4,count) values(?,?,?,?,?,?,?,?,?)"; // insert 쿼리문
