	  	...
	  	while(rs.next()){  		
            ...
            if(item_status == 0)
            {
            	out.println("<div class='single-products-catagory clearfix'><a href = 'view_detail.jsp?item_num=" + item_num +"'><img src= 'img/item/" + imgAddress1 + 
            	  		"'><div class='hover-content'><div class='line'></div><span style = 'background-color:#f9a825;padding-top:5px; color:#fff;font-size:17px;padding-bottom:3px;'>&nbsp;&nbsp;"+ item_price + "₩&nbsp;&nbsp;</span><h4 style = 'margin-top:5px;background-color:#000;padding-top:5px; color:#fff'>&nbsp; " + item_name + "&nbsp;&nbsp; </h4></div></a></div>");
            }
