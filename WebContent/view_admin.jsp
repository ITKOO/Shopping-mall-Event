                            ...
                            <div class="col-lg-12">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-collection-image"></i>Detail View List</h3>
	...
	try{
		Connection conn = DriverManager.getConnection(url, id, pw); //실제연동시도
	  	...
	  	while(rs.next()){  		
            ...
            out.println("<a style ='display:block;' href = 'view_detail.jsp?item_num=" + item_num +"'><div class='au-message__item unread'><div class='au-message__item-inner'><div class='au-message__item-text'><div class='avatar-wrap "+ status +"'><div class='avatar'><img src='img/item/"+ 
            imgAddress1 + "' alt='아이템사진'></div></div><div class='text'><h5 class='name'>" + item_name + "</h5><p>" + item_price + "₩</p></div></div><a href = 'deleteProc.jsp?item_num=" +  item_num + "'>X</a></div></div></a>");
